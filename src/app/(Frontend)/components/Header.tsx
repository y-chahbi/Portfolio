...
interface HeaderProps {
  style?: string; // Use string type for the style prop
}
...
const Header: React.FC<HeaderProps> = ({ style }) => {
    return (
        <div className={style}>
            ...
            <div className="mobile-right-side flex space-x-10 md:hidden">
                <MobileNav/>
            </div>
            <div className="right-side hidden space-x-10 md:flex items-center">
