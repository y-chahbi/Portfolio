...
const Contact: React.FC<ContactProps> = ({ classname }) => {
    return (
        <div id="Contact" className={`${classname} flex-col justify-center items-center mt-[100px] md:mt-[200px]`}>
            ...
            <div className='SecondTil text-[40px] md:text-[56px] py-[10px] text-[var(--trdColor)] font-[Roboto] font-bold flex mt-[10px] justify-center'>Get In Touch</div>
            <div className='Description md:max-w-[1000px] text-[var(--seconderyColor)] px-[20px] md:px-[260] text-center'>
